...
import { Tool, ServiceAssignment, Category, Tenant, Material, User } from "../../src/models/index.models.js"; // Adjust this import to your project structure
...
describe("Tool Model", () => {
  ...
  it("should create a tool successfully with valid fields", async () => {
    ...
    expect(savedTool.serviceAssignment._id.toString()).toBe(serviceAssignment._id.toString());
  ...
  it("should correctly track history records", async () => {
    ...
    const updatedTool = await Tool.findById(tool._id).populate("history.updatedBy").exec();
